...
import AboutFounderQuote from '@/components/about/AboutFounderQuote/AboutFounderQuote';
import ClosingCTA from '@/components/home/ClosingCTA/ClosingCTA';

export const metadata = {
  title: 'About — Meridian Motors',
  description: 'Meridian Motors is a curated luxury car dealership on Victoria Island, Lagos. Founded in 2018 on principles of selectivity, independence, transparency, and patience.',
};
