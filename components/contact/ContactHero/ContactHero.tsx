      ...
      <div className={styles.grid}>
        <div data-ch-left>
          ...
          <p className={styles.body}>
            Whether you&apos;re enquiring about a specific vehicle, booking a private viewing, or simply curious — we&apos;re here. Response within one business day, or within the hour on WhatsApp.
          </p>
        </div>

        <div className={styles.imgWrap} data-ch-right>
          <Image
            src="https://images.unsplash.com/photo-1614026480209-cd9934144671?w=700&q=80&fit=crop&auto=format"
