...
export default function FinanceCalculator() {
  ...
  const [vehiclePrice, setVehiclePrice] = useState(285_000_000);
      ...
      <div className={styles.grid}>
        ...
        <div data-fc-reveal>
          ...
          <div className={styles.sliderRow}>
            <div className={styles.sliderMeta}>
              ...
              <span className={styles.sliderValue}>{depositPct}%</span>
            </div>
            <input
              type="range"
              className={styles.slider}
        ...
        <div data-fc-reveal>
          <div className={styles.imgWrap}>
            <Image
              src="https://images.unsplash.com/photo-1554995207-c18c203602cb?w=600&q=80&fit=crop&auto=format"
              alt="Financial documents and vehicle keys, representing vehicle financing"
              fill
          ...
          {formSubmitted ? (
            ...
            <form onSubmit={handleFormSubmit}>
              <div className={styles.formGrid}>
                <div>
                  <label className={styles.label} htmlFor="fc-name">Full Name</label>
                  <input
                    id="fc-name"
                    name="name"
                    type="text"
                ...
                <div>
                  <label className={styles.label} htmlFor="fc-phone">Phone</label>
                  <input
                    id="fc-phone"
                    name="phone"
                    type="tel"
                ...
                <div className={styles.fieldFull}>
                  <label className={styles.label} htmlFor="fc-vehicle">Vehicle of Interest</label>
                  <input
                    id="fc-vehicle"
                    name="vehicle"
                    type="text"
                ...
                <div className={styles.fieldFull}>
                  <label className={styles.label} htmlFor="fc-deposit">Preferred Deposit %</label>
                  <input
                    id="fc-deposit"
                    name="deposit"
                    type="text"
